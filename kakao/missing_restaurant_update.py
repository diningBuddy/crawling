...
if os.path.exists('kakao_restaurants.csv'):
  existing_df = pd.read_csv('kakao_restaurants.csv')
else:
...
not_found_file = open('not_found_restaurants.txt', mode='w', encoding='utf-8')
...
with open('missing_restaurant_names.txt', 'r', encoding='utf-8') as f:
